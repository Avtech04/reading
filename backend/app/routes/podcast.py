...
#     """
#     Creates a podcast summary from specific context provided by the frontend.
#     """
#     try:
#         if not request.context:
#             raise HTTPException(status_code=400, detail="No context provided.")

#         # 1. Generate podcast script from the provided context
#         script = generate_podcast_script(request.context)
